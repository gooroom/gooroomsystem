...
class GooroomSystem():
    ...
    def __init__(self):
        ...
        self.logfile = open("/var/log/gooroomsystem.log", "w")
        self.time_log("gooroomSystem started")
        self.executed = []
        self.overwritten = []
        self.skipped = []
        self.edited = []
    ...
    def adjust(self):
        try:
            ...
            try:
                ...
                config.read('/etc/gooroom/gooroomSystem.conf')
                ...
                with open('/etc/gooroom/gooroomSystem.conf', 'w') as configfile:
...
gooroomsystem = GooroomSystem()
gooroomsystem.adjust()
gooroomsystem.quit()
